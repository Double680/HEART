...
class QwenReranker:
    def __init__(self, model_path):
        ...
        self.instruction = "Judge whether the table header is relevant to answer the question. "
    ...
    def judge_relevance(self, docs, queries):
        prompts = [self.process_inputs(doc, query) for doc, query in zip(docs, queries)]
